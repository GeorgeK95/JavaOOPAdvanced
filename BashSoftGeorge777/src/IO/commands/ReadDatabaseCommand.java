...
public class ReadDatabaseCommand extends Command {
    ...
    public ReadDatabaseCommand(String line, String[] data, DirectoryManager ioManager, ContentComparer tester, Downloader downloadManager, Database studentsRepository) {
