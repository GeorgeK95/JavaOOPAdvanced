...
public interface StrategyHolder {
    ...
    /**
     * A method for adding a new Annotation class and corresponding strategies to the currently contained disposal strategies. annotationClass
    ...
    /**
     * A method for removing an existing Annotation class and its corresponding strategies. annotationClass
     * should be a class of type annotation, implementing the Framework's Disposable meta-annotation.
     * @param annotationClass An annotation class that implements the Framework's Disposable meta-annotation.
